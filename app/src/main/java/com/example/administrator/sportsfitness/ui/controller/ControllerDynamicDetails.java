                        ...
                        if (dynamicDetailsNetBean.getStatus() == 1) {
                            ...
                            if (photoList.size() == 0 && imgpathjson != null) {
                                ...
                                if (photoList.size() == 1 && SystemUtil.JudgeNetFilePathType(photoList.get(0))) {
                                    ...
                                    video_view.setVideoPath(photoList.get(0), null, null);
                                } else if (!detail.getVideopath().isEmpty()) {
                                    video_view.setVisibility(View.VISIBLE);
                                    video_view.setVideoPath(SystemUtil.JudgeUrl(detail.getVideopath()), null, photoList.get(0));
                                } else {
