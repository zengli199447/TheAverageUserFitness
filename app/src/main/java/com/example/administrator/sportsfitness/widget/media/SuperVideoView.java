...
public class SuperVideoView extends RelativeLayout {
     ...
     * @param path
     */
    public void setVideoPath(String path, String name, String coverUrl) {
//        path = "http://192.168.2.197:8080/data/video/dzt6.mp4";
        ...
        if (path.startsWith("http") || path.startsWith("https")) {
            ...
            if (coverUrl != null) {
                Glide.with(cover.getContext()).load(coverUrl).fitCenter().error(R.drawable.banner_off).into(cover);
            }else {
