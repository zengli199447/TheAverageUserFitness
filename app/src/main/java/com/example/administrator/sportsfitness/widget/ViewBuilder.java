...
public class ViewBuilder {
    ...
    //边距修改
    public static void ChangeRelativeLayoutViewMagin(Context context, View view, int lifeMagin, int topMagin, int rightMagin, int bottomMagin) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) view.getLayoutParams();
        layoutParams.setMargins(SystemUtil.dp2px(context, lifeMagin),
                SystemUtil.dp2px(context, topMagin),
                SystemUtil.dp2px(context, rightMagin),
                SystemUtil.dp2px(context, bottomMagin));
        view.setLayoutParams(layoutParams);
    }

    //边距修改
    public static void ChangeLinearLayoutViewMagin(Context context, View view, int lifeMagin, int topMagin, int rightMagin, int bottomMagin) {
