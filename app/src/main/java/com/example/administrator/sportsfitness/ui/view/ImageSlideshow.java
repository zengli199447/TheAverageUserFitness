...
import com.example.administrator.sportsfitness.model.bean.ImageTitleNetBean;
...
public class ImageSlideshow extends FrameLayout {
    ...
    private void initAnimator() {
        animatorToLarge = AnimatorInflater.loadAnimator(context, R.anim.scale_to_large);
        animatorToSmall = AnimatorInflater.loadAnimator(context, R.anim.scale_to_small);
    }
    ...
    private void initView() {
        contentView = LayoutInflater.from(context).inflate(R.layout.layout_image_slide_show, this, true);
    ...
    private void setIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            view.setBackgroundResource(R.drawable.corners_banner_point_bg_disable);
        ...
        llDot.getChildAt(0).setBackgroundResource(R.drawable.corners_banner_point_bg_enable);
        ...
        vpImageTitle.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(final int position) {
                ...
                for (int i = 0; i < llDot.getChildCount(); i++) {
                    if (i == position - 1) {// 被选中
                        llDot.getChildAt(i).setBackgroundResource(R.drawable.corners_banner_point_bg_enable);
                        if (!isLarge.get(i)) {
                        ...
                        llDot.getChildAt(i).setBackgroundResource(R.drawable.corners_banner_point_bg_disable);
                        if (isLarge.get(i)) {
    ...
    private void setViewList(List<ImageTitleNetBean> imageTitleBeanList) {
        ...
        for (int i = 0; i < count + 2; i++) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_image_slide_show, null);
