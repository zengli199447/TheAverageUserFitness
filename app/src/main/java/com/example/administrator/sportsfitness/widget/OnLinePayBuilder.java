...
import com.example.administrator.sportsfitness.widget.pay.PayResult;
import com.example.administrator.sportsfitness.widget.pay.PayUitl;
...
public class OnLinePayBuilder {
     ...
     * @param totalmoney
     */
    public void doAlipay(String subject, String body, String out_trade_no, String notify_url, String partner, String seller, String private_key, String totalmoney, final int payStatus) {
        ...
        MyApplication.executorService.submit(new Runnable() {
            ...
            public void run() {
                ...
                RxBus.getDefault().post(new CommonEvent(payStatus, status));
