...
//TODO callback
public class StickyBoContentTextBuilder {
    ...
    public SpannableStringBuilder getWeiBoContent(final String source, final Context context, final TextView textView, final int Index) {
        ...
        while (matcher.find()) {
            ...
            if (at != null) {
                ...
                ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan(context.getResources().getColor(R.color.blue_bar));
        ...
        final BackgroundColorSpan span = new BackgroundColorSpan(context.getResources().getColor(R.color.translucent));
    ...
    public void setOnStickyBoContentTextClickListener(OnStickyBoContentTextClickListener onStickyBoContentTextClickListener) {
        this.onStickyBoContentTextClickListener = onStickyBoContentTextClickListener;
    }
