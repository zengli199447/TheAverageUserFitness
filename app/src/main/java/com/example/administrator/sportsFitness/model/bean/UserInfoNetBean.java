 ...
 * remark:
 */
public class UserInfoNetBean implements Serializable{
    ...
    public static class ResultBean implements Serializable{
        ...
        public String getSignature_show() {
            return signature_show;
        }

        public void setSignature_show(String signature_show) {
            this.signature_show = signature_show;
        }
    }
}
